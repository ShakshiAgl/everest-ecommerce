          ...
          <div className="flex sm:flex-col overflow-x-auto sm:overflow-y-scroll sm:w-[18%] w-full">
            {productData.image?.map((item, index) => (
              <motion.img
                ...
                src={item}
                whileTap={{ scale: 0.95 }}
                className={`w-[30%] sm:w-[100px] sm:h-[100px] object-cover cursor-pointer border rounded-md transition-all duration-300 ${
                  image === item
            ...
            <AnimatePresence mode="wait">
              {image && (
                <motion.img
                  ...
                  src={image}
                  className="max-w-[500px] max-h-[500px] w-full object-contain border rounded-md"
                  alt=""
                />
              )}
            </AnimatePresence>
